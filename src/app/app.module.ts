...
import { PageSideNavComponent } from './shared/components/page-side-nav/page-side-nav.component';
...
@NgModule({
  declarations: [
    AppComponent,PageHeaderComponent,PageFooterComponent,PageSideNavComponent,
    PageNotFoundComponent,RegisterComponent,LoginComponent,BookStoreComponent,UserOrdersComponent,
    ProfileComponent,MaintenanceComponent,ReturnBookComponent,PageTableComponent,ApprovalRequestsComponent,AllOrdersComponent,ViewUsersComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
